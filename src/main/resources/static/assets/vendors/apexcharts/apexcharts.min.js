        ...
        return r(t, [{
            ...
            key: "drawText", value: function (t) {
                ...
                return Array.isArray(r) ? m = b.globals.dom.Paper.text((function (t) {
                    for (var a = 0; a < r.length; a++) g && (v = i.getTextBasedOnMaxWidth(e({text: r[a]}, y))), 0 === a ? t.tspan(v) : t.tspan(v).newLine()
        ...
        return r(t, [{
            ...
            key: "_handlePaths", value: function (t) {
                ...
                if (o.config.stroke.show && !this.pointsChart) {
                    var b = null;
                    if ("line" === i) b = l.fillPath({seriesNumber: a, i: s}); else if (o.config.stroke.fill) {
                        var v = o.config.fill;
