...
import com.pixeltribe.forumsys.postlike.model.PostLikeUpdateDTO;
...
public class PostLikeController {
    ...
    public List<PostLikeDTO> getPostLike() {
    ...
    public ResponseEntity<PostLikeDTO> UpdatePostLike(
            @Valid @RequestBody PostLikeUpdateDTO postLikeUpdateDTO,
        ...
        PostLikeDTO postLikeCreate = postLikeService.updatePostLike(postNo, memberId, postLikeUpdateDTO.getPLikeStatus());
