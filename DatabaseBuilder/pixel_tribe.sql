...
(
    ...
    FOR_IMG        LONGBLOB COMMENT '討論區圖片',
    FOREIGN KEY (`CAT_NO`)
...
-- 新增 討論區 資料 --  
INSERT INTO FORUM (`FOR_NAME`, `CAT_NO`, `FOR_DES`, `FOR_DATE`, `FOR_UPDATE`)
VALUES ('原神', '1', '全球知名的開放世界動作RPG，強調元素反應戰鬥與豐富探索。', '2024-06-05 9:00:00',
       ...
       ('最終幻想VII 重生', '1', '經forum典日系RPG《FFVII》重製版第二部，以壯闊劇情與創新戰鬥系統吸引玩家。',
        '2024-06-12 13:45:20', '2024-06-12 13:50:30'),
