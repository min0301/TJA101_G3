...
('林志偉', '烈焰戰神', 'demo_user', 'MySecret99', 'i7j8k9l@TJA101.com.tw', 'mem4.png', '臺北市大同區民族西路36號',
 '0939489171',
 '1995-03-01', '2024-04-18 10:05:00', '2025-02-20 09:30:00', '1', NULL, NULL, TRUE, TRUE, FALSE, TRUE, 7),
('張雅婷', '月影潛行者', 'info_test', 'Strong@Pass', 'm0n1o2p@TJA101.com.tw', 'mem5.png', '臺北市中山區松江路76號',
 '0910347356',
 '1992-07-10', '2024-05-22 17:30:00', '2025-03-15 14:10:00', '1', NULL, NULL, TRUE, TRUE, FALSE, TRUE, 0),
('李文傑', '聖光使者', 'another_user', 'Complex#123', 'q3r4s5t@TJA101.com.tw', 'mem6.png', '彰化縣大村鄉學府路56號',
 '0933984252',
 '2000-01-25', '2024-06-30 08:00:00', '2025-04-25 12:20:00', '1', NULL, NULL, TRUE, TRUE, FALSE, TRUE, 3),
('黃美玲', '暗夜精靈', 'test_sample', 'SimplePass', 'u6v7w8x@TJA101.com.tw', 'mem7.png',
 '桃園市平鎮區廣豐街福壽四巷14號3樓',
 '0935633441', '1985-09-08', '2024-07-10 13:15:00', '2025-05-01 15:55:00', '1', NULL, NULL, TRUE, TRUE, FALSE, TRUE, 0),
('劉俊豪', '疾風之狼', 'data_user', 'HardToGuess', 'y9z0a1b@TJA101.com.tw', 'mem8.png', '屏東縣萬丹鄉吉林路30號',
 '0922914555',
...
('楊宗翰', '蒼穹之鷹', 'account_test', 'MySecureKey', 'g5h6i7j@TJA101.com.tw', 'mem10.png', '苗栗縣大湖鄉信義路50號',
 '0987839119',
 '1989-06-30', '2024-10-01 14:00:00', '2025-06-01 09:10:00', '1', NULL, NULL, TRUE, TRUE, FALSE, TRUE, 4),
('吳怡君', '碧海遊龍', 'tester_user', 'JustATest', 'k8l9m0n@TJA101.com.tw', 'mem11.png', '臺南市關廟區中山路２段77號',
 '0926380187',
...
('徐國樑', '幽夢旅人', 'beta_tester', 'SuperSecret#01', 's4t5u6v@TJA101.com.tw', 'mem13.png',
 '臺中市大里區東明路52號4樓',
...
(
    ...
    INDEX `idx_postno_messtatus` (`POST_NO`, `MES_STATUS`),
    FOREIGN KEY (`POST_NO`) REFERENCES FORUM_POST (`POST_NO`) ON DELETE SET NULL ON UPDATE CASCADE,
    FOREIGN KEY (`MEM_NO`) REFERENCES MEMBER (`MEM_NO`) ON DELETE SET NULL ON UPDATE CASCADE
) COMMENT '文章留言';
